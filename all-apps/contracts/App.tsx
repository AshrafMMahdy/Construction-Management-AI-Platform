...
function App() {
  ...
  const handleCreateNewProjectClick = () => {
    ...
    const handleDeleteProject = useCallback(async (projectToDelete: ProjectSummary) => {
        ...
        setError(null);
        try {
            const response = await fetch(`/api/projects?url=${encodeURIComponent(projectToDelete.url)}`, {
                method: 'DELETE',
            });
  ...
  const handleSaveProject = useCallback(async () => {
    ...
    try {
        ...
        const updatedProjectState = { ...payload, id: savedProject.id };
  ...
  }, [currentProject, newProjectName, databaseFile, contractFile, searchQuery, analysisResults, searchResults]);
