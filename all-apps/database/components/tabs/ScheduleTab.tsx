...
const ScheduleTab: React.FC<ScheduleTabProps> = ({ project }) => {
  const hasScheduleData = project.generatedSchedule && project.generatedSchedule.length > 0;
    ...
    <div className="space-y-8 animate-slide-in-up">
      <div className="bg-base-100 p-6 rounded-lg shadow-lg border border-base-300">
        ...
        <p className="text-base-content-secondary mb-4">
          Schedule management and modifications are handled in the Baseline Scheduler application.
        </p>
        <a 
      ...
      <div className="bg-base-100 p-6 rounded-lg shadow-lg border border-base-300">
        ...
        <p className="whitespace-pre-wrap text-base-content-secondary bg-base-200 p-4 rounded-md">{project.generatedNarrative || 'No AI narrative is available for this project.'}</p>
      </div>
