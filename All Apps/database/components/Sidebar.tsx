...
import { FolderIcon, ArrowTopRightOnSquareIcon, ChartBarIcon, DocumentTextIcon, ExclamationTriangleIcon } from './Icons';
...
const Sidebar: React.FC<SidebarProps> = ({ projects, selectedProjectId, onSelectProject }) => {
  return (
    <div className="w-72 bg-base-100 border-r border-base-300 flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <h2 className="text-xs font-bold uppercase text-base-content-secondary mb-2">Projects</h2>
      ...
      <div className="p-4 border-t border-base-300">
         <h2 className="text-xs font-bold uppercase text-base-content-secondary mb-3">Connected Apps</h2>
         <ul className="space-y-1">
