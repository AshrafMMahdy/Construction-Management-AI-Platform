...
const SavedProjects: React.FC<SavedProjectsProps> = ({ projects, currentProjectId, onLoad, onDelete, onRename, disabled, isLoading }) => {
    ...
    const handleSaveEdit = async () => {
        if (editingId && editedName.trim()) {
            await onRename(editingId, editedName.trim());
        }
        handleCancelEdit();
    };
