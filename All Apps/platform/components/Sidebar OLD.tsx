    ...
    return (
        <aside className="w-64 flex flex-col bg-brand-primary text-white p-4">
            ...
            <nav className="flex-1 flex flex-col space-y-2">
                ...
                <NavLink
                    icon={<ScheduleIcon className={`h-5 w-5 transition-colors ${activeView === 'scheduling' ? 'text-white' : 'text-gray-400 group-hover:text-white'}`} />}
                    isActive={activeView === 'scheduling'}
                    onClick={() => setActiveView('scheduling')}
                >
                    Scheduling
                </NavLink>
                <NavLink
                    icon={<ContractIcon className={`h-5 w-5 transition-colors ${activeView === 'contracts' ? 'text-white' : 'text-gray-400 group-hover:text-white'}`} />}
                ...
                <NavLink
                    icon={<DelayIcon className={`h-5 w-5 transition-colors ${activeView === 'delay' ? 'text-white' : 'text-gray-400 group-hover:text-white'}`} />}
                    isActive={activeView === 'delay'}
